...
interface AccountCreationProps {
  ...
  openTermsModal: (e: React.MouseEvent | React.ChangeEvent<HTMLInputElement>) => void
  phoneNumber: string
      ...
      <form onSubmit={handleCreateAccount}>
        ...
        <div className="mb-6">
          ...
          {confirmPasswordError && confirmPassword && (
            <p className={`text-sm mt-1 ${isDarkMode ? "text-red-400" : "text-red-500"}`}>{confirmPasswordError}</p>
          )}
        </div>
