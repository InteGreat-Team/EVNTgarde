...
const ActivityOverview: React.FC = () => {
  ...
  useEffect(() => {
    const storedRole = localStorage.getItem("userType") as userType | null;
    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-6 rounded shadow border border-blue-400">
          ...
          <p className="text-4xl font-bold mt-2">1,020</p>
        </div>
        ...
        <div className="bg-white p-6 rounded shadow border border-blue-400">
          ...
          <div className="flex items-center mt-2 text-xs text-green-600">
            ...
            <span>{isCustomer ? "10% increase since July" : "12% increase since July"}</span>
          </div>
        </div>

        <div className="bg-white p-6 rounded shadow border border-blue-400">
          <h3 className="text-sm font-medium text-gray-500">
            {isCustomer ? "What Organizers Say About You" : "Customer Satisfaction Rating"}
          </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        {isCustomer ? (
          <div className="bg-white p-6 rounded shadow border border-blue-400">
            ...
            <p className="text-4xl font-bold mt-2">$ 24,205.00</p>
          </div>
        ) : (
          <>
            <div className="bg-white p-6 rounded shadow border border-blue-400">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-4 rounded shadow border border-blue-400 md:col-span-1">
          <CalendarCard initialMonth="April" initialYear={2025} takenDates={takenDates} />
        </div>

        <div className="bg-white p-6 rounded shadow border border-blue-400 md:col-span-2">
