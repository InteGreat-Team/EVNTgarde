    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 backdrop-blur-sm">
      ...
      >
        <div className="p-4 flex-shrink-0">
          <h2 className="text-2xl font-semibold text-[#3061AD] mb-6">
            Create Event
          </h2>
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              ...
              <div
                className={`ml-2 text-sm ${step === 1 ? "text-[#3061AD] font-medium" : "text-gray-500"}`}
              >
                Event Details
              </div>
            </div>
            ...
            <div
              className={`flex-1 h-0.5 mx-4 ${step > 1 ? "bg-[#3061AD]" : "bg-gray-200"}`}
            ></div>
            ...
            <div className="flex items-center">
              ...
              <div
                className={`ml-2 text-sm ${step === 2 ? "text-[#3061AD] font-medium" : "text-gray-500"}`}
              >
                Services
              </div>
            </div>
            ...
            <div
              className={`flex-1 h-0.5 mx-4 ${step > 2 ? "bg-[#3061AD]" : "bg-gray-200"}`}
            ></div>
            ...
            <div className="flex items-center">
              ...
              <div
                className={`ml-2 text-sm ${step === 3 ? "text-[#3061AD] font-medium" : "text-gray-500"}`}
              >
                Preview
              </div>
            </div>
        ...
        <div className="overflow-y-auto p-4 flex-grow">
              ...
              <div>
                ...
                <div className="relative">
                  <select
                    ...
                    onChange={(e) =>
                      handleInputChange("attire", e.target.value)
                    }
                  >
              ...
              <div>
                ...
                <div className="border border-dashed border-gray-300 rounded-md p-6 flex flex-col items-center justify-center">
                  ...
                  <p className="text-xs text-gray-500 text-center">
                    Sample files: event banners, speaker photos, schedules,
                    promotional posters, or presentation slides
                  </p>
                  <button
          ...
          {step === 3 && (
            <div className="space-y-4">
              <div>
                <h3 className="text-lg font-medium text-[#3061AD] mb-4">
                  Event Details
                </h3>
              ...
              <div className="flex justify-between items-center">
                <h3 className="text-lg font-medium text-[#3061AD]">
                  Total Event Budget
                </h3>
                <p className="text-xl font-semibold text-[#3061AD]">
                  {eventData.budget}
                </p>
              </div>
            </div>
